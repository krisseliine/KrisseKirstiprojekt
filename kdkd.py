...
##            algus(j,0)
    ...
    if n >= len(küsitav):
        ...
        tahvel6 = Canvas(raam6,  background="maroon1")
        tahvel6.grid()
        j2=-1
        ...
        misedasi = ttk.Label(tahvel6, text="Kui soovid uuesti, vajuta nuppu: 'Uuesti!'"+"\n"+\
        ...
        if n==0:
            ...
            tahvel3 = Canvas(raam3,  background="magenta3")
            tahvel3.grid()
            küsitav2 = ttk.Label(tahvel3, text=küsitav[n])
            ...
            raam3.resizable(width=FALSE, height=FALSE)
            raam3.title("Tõlkeprogramm")
            tahvel3 = Canvas(raam3,  background="HotPink2")
            tahvel3.grid()
            küsitav2 = ttk.Label(tahvel3, text=küsitav[n])
            küsitav2.grid(column=0, row=0, padx=5, pady=5, sticky=(E,N,W))
...
def proov(j, küsibfailinime, esteng1,n):
    ...
    tahvel2 = Canvas(raam2,  background="PaleTurquoise")
    tahvel2.grid()
...
#            break
    ...
    if len(küsitav) == 0:
        ...
        raam7.title("Viga!")
        tahvel7 = Canvas(raam7, background="medium orchid")
...
def algus(j,n):
    ...
    pilt=PhotoImage(file="proov3.gif")
    tahvel = Canvas(raam, background="HotPink")
...
#Teen nupu ning annan commandi talle selle, mis ta teeb kui vajutatakse nuppu, ehk siis funktsiooni
    ...
    nupp = ttk.Button(tahvel, text="Hakkame pihta!", command=lambda:proov(j,küsibfailinime,esteng1,n),fg="pink",bg="blue")
